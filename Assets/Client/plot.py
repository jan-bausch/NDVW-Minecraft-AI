...
def plot_multiple_averages(csv_filename, ignore_entries=0, server=0):
    epochs = []
    avg_q_values = []
    train_avg_q_values = []
    avg_rewards = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--server', type=int, default=0, help='Server index')
    
    args = parser.parse_args()

    plot_multiple_averages(args.csv_filename, args.ignore_entries, args.server)
