...
//             worldObject.transform.position = new Vector3(coord.x * VoxelData.ChunkWidth, 0f, coord.z * VoxelData.ChunkWidth);
//             worldObject.name = "World " + coord.x + ", " + coord.z;
...
//         public static GameObject renderVoxel(VoxelWorld world, int x, int y, int z)
//         {
...
//         public static GameObject UpdateVoxel(VoxelWorld world, int x, int y, int z)
//         {
//             int blockType = world.BlockAt(x,y,z);
//             Vector3[] vertices = new Vector3[]
//             {
...
//         public static void UpdateWorld(GameObject parent, VoxelWorld world, Material material)
//         {
//             ClearMeshes(parent);
//             RenderWorld(parent, world, material);
//         }

//         private static void ClearMeshes(GameObject parent)
//         {
//             // Destroy existing meshes and their components
